...
class Vehicle extends Model
{
    ...
    protected $fillable = [
        'sqlID', 'pvModelId', 'pvPosX', 'pvPosY', 'pvPosZ', 'pvPosAngle',
        'pvLock', 'pvLocked', 'pvPaintJob', 'pvColor1', 'pvColor2',
        'pvPrice', 'pvTicket', 'pvFuel', 'pvImpound', 'pvDisabled',
        'pvPlate', 'pvVW', 'pvInt', 'pvHealth', 'pvAlarm', 'pvStolen',
    ];

    protected static array $vehicleNames = [
        ...
        514 => 'Petrol Tanker', 515 => 'Roadtrain', 516 => 'Nebula', 517 => 'Majestic',
        ...
        530 => 'Forklift', 531 => 'Tractor', 532 => 'Combine Harvester', 533 => 'Feltzer',
        ...
        590 => 'Freight Box', 591 => 'Trailer 3', 592 => 'Andromada', 593 => 'Dodo',
        594 => 'RC Cam', 595 => 'Launch', 596 => 'Police LS', 597 => 'Police SF',
        598 => 'Police LV', 599 => 'Police Ranger', 600 => 'Picador', 601 => 'S.W.A.T.',
        602 => 'Alpha', 603 => 'Phoenix', 604 => 'Glendale Shit', 605 => 'Sadler Shit',
        606 => 'Baggage Trailer A', 607 => 'Baggage Trailer B', 608 => 'Tug Stairs',
        609 => 'Boxville Mission', 610 => 'Farm Trailer', 611 => 'Utility Trailer',
    ];

    public function owner(): \Illuminate\Database\Eloquent\Relations\BelongsTo
    {
        return $this->belongsTo(User::class, 'sqlID', 'id');
    }

    public function getVehicleNameAttribute(): string
    {
        return static::$vehicleNames[$this->pvModelId] ?? "Unknown ({$this->pvModelId})";
    }

    public function getIsImpoundedAttribute(): bool
    {
        return $this->pvImpound > 0;
    }

    public function getIsLockedAttribute(): bool
    {
        return $this->pvLocked > 0;
    }

    public function getIsDisabledAttribute(): bool
    {
        return $this->pvDisabled > 0;
    }

    public function getHealthPercentAttribute(): float
    {
        return round(($this->pvHealth / 1000) * 100, 1);
    }
}
